...
const pass = () => {
    return (
        <div className='overflow-x-hidden '>
            ...
            <p className='p-2 mt-20 text-center font-mono text-green-500 font-bold text-xl'>Congratulations, you reached your goal!</p>
            <p className='font-mono font-bold text-xl text-center'>You scored 85%</p>
            <p className='text-center font-mono font-bold text-gray-300'>Your goal: Reach 80% and above on next session</p>
            <p className='font-mono font-bold text-xl text-center mt-20'>continue working hard to reach higher heights.</p>
            <div className='flex gap-6 justify-center mt-9 cursor-pointer'>
                <div className='font-bold bg-blue-400 w-14 h-8 p-1 rounded-sm text-white'>Retry</div>
              <Link to='/Fail'>  <div className='bg-blue-400 font-bold w-40 h-8 p-1 rounded-sm text-white flex gap-2'>Next exercises <Icon icon="ri:arrow-right-double-line" color="white" width="22" />
                </div></Link>
            </div>
            </div>
            )
